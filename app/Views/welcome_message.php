...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="/dashboard/categoria">Categorías</a></li>
            <li class="menu-item hidden"><a href="/dashboard/etiqueta">Etiquetas</a></li>
            <li class="menu-item hidden"><a href="/dashboard/pelicula">Películas</a></li>
